...
### Colab namespace note

The model vector field is named `circadian_rhs` (rather than the generic `rhs`) to avoid name collisions with plotting or other Julia packages loaded in Colab.
